...
mod tests {
    ...
    fn test_derive_nh() {
        ...
        // KAT (TS 33.501 Annex A.10): NH = KDF(KAMF, 0x6F, SYNC-input[32]).
        // KAMF = 0xAA*32, SYNC-input = 0xBB*32.
        let expected_nh: [u8; 32] = [
            0x87, 0xc5, 0xc9, 0x73, 0x3a, 0x65, 0x18, 0x5a, 0x9a, 0x2e, 0xf6, 0x84, 0xe7, 0x6e,
            0xfe, 0x82, 0xdd, 0x51, 0x76, 0xa1, 0xb8, 0x41, 0x93, 0x8f, 0x39, 0xd9, 0xd8, 0xd9,
            0x80, 0xbd, 0x2d, 0xe7,
        ];
