...
mod tests {
    ...
    fn test_nea3_3gpp_test_set_1() {
        ...
        let plaintext: [u8; 25] = [
            ...
            0x25, 0xfe, 0x0b, 0xd6, 0x75, 0xd9, 0x00, 0x58, 0x75, 0xb2, 0x00,
        ];

        // Expected ciphertext
        let expected_ciphertext: [u8; 25] = [
            0xa6, 0xc8, 0x5f, 0xc6, 0x6a, 0xfb, 0x85, 0x33, 0xaa, 0xfc, 0x25, 0x18, 0xdf, 0xe7,
            0x84, 0x94, 0x0e, 0xe1, 0xe4, 0xb0, 0x30, 0x23, 0x8c, 0xc8, 0x10,
        ];
    ...
    fn test_nea3_3gpp_test_set_2() {
        let key: [u8; 16] = [
            0xe5, 0xbd, 0x3e, 0xa0, 0xeb, 0x55, 0xad, 0x8e, 0x1b, 0x19, 0x9e, 0x3e, 0xc4, 0x31,
            0x60, 0x20,
        ];
        ...
        let plaintext: [u8; 90] = [
            ...
            0x75, 0x54, 0xe0, 0x4d, 0x1f, 0x7f,
        ];

        // Expected ciphertext
        let expected_ciphertext: [u8; 90] = [
            0xf4, 0xbd, 0xcb, 0x5e, 0x8d, 0x02, 0x05, 0xda, 0x77, 0x10, 0xcc, 0x63, 0x99, 0x5b,
            0x6f, 0xa5, 0xff, 0x8d, 0xd1, 0x18, 0x52, 0x39, 0x32, 0xd2, 0x80, 0xc1, 0x1a, 0x18,
            0xd5, 0xf0, 0x6e, 0x45, 0x8f, 0x67, 0x49, 0x2c, 0xa2, 0x2a, 0xe5, 0x4e, 0xe0, 0x25,
            0x78, 0x94, 0x12, 0x3a, 0x0d, 0xf6, 0x1d, 0x78, 0x12, 0xb2, 0x45, 0x0a, 0xc1, 0x85,
            0x48, 0x96, 0x67, 0x97, 0x99, 0x74, 0x86, 0x0d, 0x6e, 0xdc, 0x13, 0xef, 0xe6, 0xd3,
            0xc0, 0xcc, 0x33, 0xe0, 0x2b, 0xc8, 0x8e, 0x78, 0x40, 0x1a, 0x32, 0x94, 0x6e, 0x2e,
            0x33, 0x30, 0xa7, 0xfd, 0x3f, 0x94,
        ];
