...
mod tests {
    ...
    fn test_milenage_3gpp_test_set_3() {
        let k: [u8; 16] = [
            0xfe, 0xc8, 0x6b, 0xa6, 0xeb, 0x70, 0x7e, 0xd0, 0x89, 0x05, 0x75, 0x7b, 0x1b, 0xb4,
            0x4b, 0x8f,
        ];
        let rand: [u8; 16] = [
            0x9f, 0x7c, 0x8d, 0x02, 0x1a, 0xcc, 0xf4, 0xdb, 0x21, 0x3c, 0xcf, 0xf0, 0xc7, 0xf7,
            0x1a, 0x6a,
        ];
        let sqn: [u8; 6] = [0x9d, 0x02, 0x77, 0x59, 0x5f, 0xfc];
        let amf: [u8; 2] = [0x72, 0x5c];
        let op: [u8; 16] = [
            0xdb, 0xc5, 0x9a, 0xdc, 0xb6, 0xf9, 0xa0, 0xef, 0x73, 0x54, 0x77, 0xb7, 0xfa, 0xdf,
            0x83, 0x74,
        ];

        let expected_opc: [u8; 16] = [
            0x10, 0x06, 0x02, 0x0f, 0x0a, 0x47, 0x8b, 0xf6, 0xb6, 0x99, 0xf1, 0x5c, 0x06, 0x2e,
            0x42, 0xb3,
        ];
        ...
        let expected_f3: [u8; 16] = [
            0x5d, 0xbd, 0xbb, 0x29, 0x54, 0xe8, 0xf3, 0xcd, 0xe6, 0x65, 0xb0, 0x46, 0x17, 0x9a,
            0x50, 0x98,
        ];
        let expected_f4: [u8; 16] = [
            0x59, 0xa9, 0x2d, 0x3b, 0x47, 0x6a, 0x04, 0x43, 0x48, 0x70, 0x55, 0xcf, 0x88, 0xb2,
            0x30, 0x7b,
        ];
    ...
    fn test_milenage_3gpp_test_set_4() {
        let k: [u8; 16] = [
            0x9e, 0x59, 0x44, 0xae, 0xa9, 0x4b, 0x81, 0x16, 0x5c, 0x82, 0xfb, 0xf9, 0xf3, 0x2d,
            0xb7, 0x51,
        ];
        let rand: [u8; 16] = [
            0xce, 0x83, 0xdb, 0xc5, 0x4a, 0xc0, 0x27, 0x4a, 0x15, 0x7c, 0x17, 0xf8, 0x0d, 0x01,
            0x7b, 0xd6,
        ];
        let sqn: [u8; 6] = [0x0b, 0x60, 0x4a, 0x81, 0xec, 0xa8];
        let amf: [u8; 2] = [0x9e, 0x09];
        let op: [u8; 16] = [
            0x22, 0x30, 0x14, 0xc5, 0x80, 0x66, 0x94, 0xc0, 0x07, 0xca, 0x1e, 0xee, 0xf5, 0x7f,
            0x00, 0x4f,
        ];

        let expected_opc: [u8; 16] = [
            0xa6, 0x4a, 0x50, 0x7a, 0xe1, 0xa2, 0xa9, 0x8b, 0xb8, 0x8e, 0xb4, 0x21, 0x01, 0x35,
            0xdc, 0x87,
        ];
        ...
        let expected_f3: [u8; 16] = [
            0xe2, 0x03, 0xed, 0xb3, 0x97, 0x15, 0x74, 0xf5, 0xa9, 0x4b, 0x0d, 0x61, 0xb8, 0x16,
            0x34, 0x5d,
        ];
        let expected_f4: [u8; 16] = [
            0x0c, 0x45, 0x24, 0xad, 0xea, 0xc0, 0x41, 0xc4, 0xdd, 0x83, 0x0d, 0x20, 0x85, 0x4f,
            0xc4, 0x6b,
        ];
    ...
    fn test_milenage_3gpp_test_set_5() {
        let k: [u8; 16] = [
            0x4a, 0xb1, 0xde, 0xb0, 0x5c, 0xa6, 0xce, 0xb0, 0x51, 0xfc, 0x98, 0xe7, 0x7d, 0x02,
            0x6a, 0x84,
        ];
        let rand: [u8; 16] = [
            0x74, 0xb0, 0xcd, 0x60, 0x31, 0xa1, 0xc8, 0x33, 0x9b, 0x2b, 0x6c, 0xe2, 0xb8, 0xc4,
            0xa1, 0x86,
        ];
        let sqn: [u8; 6] = [0xe8, 0x80, 0xa1, 0xb5, 0x80, 0xb6];
        let amf: [u8; 2] = [0x9f, 0x07];
        let op: [u8; 16] = [
            0x2d, 0x16, 0xc5, 0xcd, 0x1f, 0xdf, 0x6b, 0x22, 0x38, 0x35, 0x84, 0xe3, 0xbe, 0xf2,
            0xa8, 0xd8,
        ];

        let expected_opc: [u8; 16] = [
            0xdc, 0xf0, 0x7c, 0xbd, 0x51, 0x85, 0x52, 0x90, 0xb9, 0x2a, 0x07, 0xa9, 0x89, 0x1e,
            0x52, 0x3e,
        ];
        ...
        let expected_f3: [u8; 16] = [
            0x76, 0x57, 0x76, 0x6b, 0x37, 0x3d, 0x1c, 0x21, 0x38, 0xf3, 0x07, 0xe3, 0xde, 0x92,
            0x42, 0xf9,
        ];
        let expected_f4: [u8; 16] = [
            0x1c, 0x42, 0xe9, 0x60, 0xd8, 0x9b, 0x8f, 0xa9, 0x9f, 0x27, 0x44, 0xe0, 0x70, 0x8c,
            0xcb, 0x53,
        ];
    ...
    fn test_milenage_3gpp_test_set_6() {
        let k: [u8; 16] = [
            0x6c, 0x38, 0xa1, 0x16, 0xac, 0x28, 0x0c, 0x45, 0x4f, 0x59, 0x33, 0x2e, 0xe3, 0x5c,
            0x8c, 0x4f,
        ];
        let rand: [u8; 16] = [
            0xee, 0x64, 0x66, 0xbc, 0x96, 0x20, 0x2c, 0x5a, 0x55, 0x7a, 0xbb, 0xef, 0xf8, 0xba,
            0xbf, 0x63,
        ];
        let sqn: [u8; 6] = [0x41, 0x4b, 0x98, 0x22, 0x21, 0x81];
        let amf: [u8; 2] = [0x44, 0x64];
        let op: [u8; 16] = [
            0x1b, 0xa0, 0x0a, 0x1a, 0x7c, 0x67, 0x00, 0xac, 0x8c, 0x3f, 0xf3, 0xe9, 0x6a, 0xd0,
            0x87, 0x25,
        ];

        let expected_opc: [u8; 16] = [
            0x38, 0x03, 0xef, 0x53, 0x63, 0xb9, 0x47, 0xc6, 0xaa, 0xa2, 0x25, 0xe5, 0x8f, 0xae,
            0x39, 0x34,
        ];
        ...
        let expected_f3: [u8; 16] = [
            0x3f, 0x8c, 0x75, 0x87, 0xfe, 0x8e, 0x4b, 0x23, 0x3a, 0xf6, 0x76, 0xae, 0xde, 0x30,
            0xba, 0x3b,
        ];
        let expected_f4: [u8; 16] = [
            0xa7, 0x46, 0x6c, 0xc1, 0xe6, 0xb2, 0xa1, 0x33, 0x7d, 0x49, 0xd3, 0xb6, 0x6e, 0x95,
            0xd7, 0xb4,
        ];
...
mod debug_tests {
    ...
    fn test_aes_encryption_for_opc() {
        ...
        let expected_encrypted: [u8; 16] = [
            0x00, 0xa1, 0xc9, 0xa4, 0x87, 0x74, 0xbf, 0xb8, 0x63, 0xc8, 0xfe, 0x24, 0xf0, 0x8c,
            0x98, 0xb7,
        ];
