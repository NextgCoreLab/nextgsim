...
mod tests {
    ...
    fn test_milenage_3gpp_test_set_2() {
        ...
        let sqn: [u8; 6] = [0xfd, 0x8e, 0xef, 0x40, 0xdf, 0x7d];
        let amf: [u8; 2] = [0xaf, 0x17];
        let op: [u8; 16] = [
        ...
        let expected_opc: [u8; 16] = [
            ...
            0x19, 0x13, 0xc0, 0x57, 0x89, 0x52, 0x09, 0xbd,
        ];

        // Expected outputs
        let expected_f1: [u8; 8] = [0x5d, 0xf5, 0xb3, 0x18, 0x07, 0xe2, 0x58, 0xb0];
        let expected_f1_star: [u8; 8] = [0xa8, 0xc0, 0x16, 0xe5, 0x1e, 0xf4, 0xa3, 0x43];
        let expected_f2: [u8; 8] = [0xd3, 0xa6, 0x28, 0xed, 0x98, 0x86, 0x20, 0xf0];
        let expected_f3: [u8; 16] = [
        ...
        let expected_f5: [u8; 6] = [0xc4, 0x77, 0x83, 0x99, 0x5f, 0x72];
        let expected_f5_star: [u8; 6] = [0x30, 0xf1, 0x19, 0x70, 0x61, 0xc1];
    ...
    fn test_milenage_3gpp_test_set_3() {
        let k: [u8; 16] = [
            0xfe, 0xa8, 0xab, 0x20, 0xaf, 0xfb, 0x28, 0x4f,
            0xb7, 0x51, 0x4e, 0x8e, 0x0e, 0x9e, 0x36, 0x36,
        ];
        let rand: [u8; 16] = [
    ...
    fn test_milenage_3gpp_test_set_5() {
        ...
        let expected_f3: [u8; 16] = [
            0x76, 0x57, 0x76, 0x7c, 0xbd, 0x99, 0x00, 0x5e,
            0xbb, 0x2a, 0x2e, 0x8d, 0xd8, 0x97, 0xdf, 0x76,
        ];
        let expected_f4: [u8; 16] = [
...
mod debug_tests {
    ...
    fn test_aes_encryption_for_opc() {
        ...
        eprintln!("K:         {:02x?}", k);
        eprintln!("OP:        {:02x?}", op);
        eprintln!("E_K(OP):   {:02x?}", encrypted);
        eprintln!("Expected:  {:02x?}", expected_encrypted);
